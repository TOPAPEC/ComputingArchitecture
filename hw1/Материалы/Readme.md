...
Программа достаточно простая и короткая, поэтому время исполнения ведет себя нестабильно и меняется от запуска к запуску. Время исполнения каждого набора тестов лежит в директории hw1\tests.
